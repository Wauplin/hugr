...
const BatonBrainFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_batonbrain_free(ptr >>> 0, 1));
/**
 ...
 */
export class BatonBrain {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(BatonBrain.prototype);
        obj.__wbg_ptr = ptr;
        BatonBrainFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        BatonBrainFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_batonbrain_free(ptr, 0);
    }
    /**
     ...
     */
    inflightLen() {
        const ret = wasm.batonbrain_inflightLen(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {BatonBrain}
     */
    static withDefaultPolicy() {
        const ret = wasm.batonbrain_withDefaultPolicy();
        return BatonBrain.__wrap(ret);
    }
    /**
     ...
     */
    constructor(policy_json) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(policy_json, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.batonbrain_new(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            ...
            this.__wbg_ptr = r0 >>> 0;
            BatonBrainFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    ...
    poll() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.batonbrain_poll(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
    ...
    submit(event_json) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(event_json, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.batonbrain_submit(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    logJson() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.batonbrain_logJson(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('baton_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
