...
//! traces in the portable `hugr-replay` format so a TS-recorded session
...
impl AgentSession {
    ...
    /// The session as a portable `hugr-replay` trace (meta unstamped — the
