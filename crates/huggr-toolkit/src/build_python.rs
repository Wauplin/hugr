//! `huggr build --surface python`: generate a PyO3 + maturin project exposing a
...
fn ask_json(
    ...
    py.allow_threads(move || {{
        ...
        let answer = rt.block_on(huggr_toolkit::surface::ask_bundle_with_options(
...
# Stable contract models, mirroring crates/huggr-agent/src/contract.rs.
