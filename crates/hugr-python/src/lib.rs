//! `hugr_agents._native` — the PyO3 embedding of the Hugr subagent runtime.
//!
...
//! Assembly reuses `hugr_toolkit::runtime::build_agent_with_options`, so a
...
use hugr_agent::{Agent, AgentEvent, Ask, StatsOptions, TraceId};
use hugr_toolkit::runtime::build_agent_with_options;
...
struct EventStream {
    ...
    handle: Mutex<Option<JoinHandle<Result<hugr_agent::Answer, hugr_agent::AskError>>>>,
    runtime: Arc<tokio::runtime::Runtime>,
}
