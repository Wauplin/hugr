//! # hugr-plugin-abi — the plugin ABI
//!
//! Third parties extend Hugr with new tools **without recompiling the core**
...
//! ```
//!
//! Every payload is an opaque [`Value`](hugr_core::Value): adding a tool or an
...
//! ## Where IO lives
//!
//! Like `hugr-replay`, this is a **host-side** crate: it may spawn processes and
