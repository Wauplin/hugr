...
When returning related documents, provide only source paths relative to the documentation root. Do not construct public URLs; Huggr adds those deterministically after your final answer.
